...
def main():
    ...
    parser.add_argument("-i", "--interface", help="Interface to use, default is eth0", default='eth0')
    ...
    parser.add_argument("-o", "--output", help="Dumps http requests in a txt file", required=True)
    parser.add_argument("-pcap", "--pcap file", help="Path to pcap file")
